...
ActiveRecord::Schema.define(version: 20150811032024) do
  ...
  add_index "old@users", ["email"], name: "index_users_on_email", unique: true, using: :btree
  add_index "old@users", ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
